...
HD_PWD='C:/Users/kound/fingerprint_processor/fingerprint_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fingerprint_processor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fingerprint_processor_top.tcl
